...
class AttributesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attribute" do
    assert_difference('Attribute.count') do
      post attributes_url, params: { attribute: { entity_id: @attribute.entity_id, name: @attribute.name } }, as: :json
    end
  ...
  test "should update attribute" do
    patch attribute_url(@attribute), params: { attribute: { entity_id: @attribute.entity_id, name: @attribute.name } }, as: :json
    assert_response 200
  end
